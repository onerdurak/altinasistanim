...
class _SupportDeveloperPageState extends State<SupportDeveloperPage> {
  ...
  String get _subscriptionId =>
      Platform.isIOS ? 'aylik_destek' : 'aylik20plan';
    ...
    for (var purchaseDetails in purchaseDetailsList) {
      if (purchaseDetails.status == PurchaseStatus.pending) {
        ...
        if (purchaseDetails.status == PurchaseStatus.error) {
          ...
          setState(() {});
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text("Abonelik aktif! Teşekkürler 💛"),
              ...
              : ListView(
                  ...
                  children: [
                    const Icon(Icons.favorite_rounded,
                        size: 72, color: AppTheme.goldMain),
                    const SizedBox(height: 20),
                    const Text(
                      "Aylık aboneliğinizle Altın Asistanım'ı destekleyebilir, "
                      "yeni özelliklerin geliştirilmesine katkıda bulunabilirsiniz.",
                      ...
                      Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text("Aktif Destekçi — Teşekkürler!",
                                style: TextStyle(
                    ...
                    if (subProduct != null) ...[
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          const Text(
                              "Abonelik süresince geliştiriciye aylık destek vermiş olursunuz.",
                              textAlign: TextAlign.center,
                              style: TextStyle(
